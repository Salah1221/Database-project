...
const NavDashboard = ({ loggedInUserId }) => {
  return (
    <header className="print">
      <div className="container container--header flex space-between align-center">
        <div className="flex align-center" style={{ "--gap": 9.5 + "rem" }}>
          <Link
            to={"/"}
            className="flex logo ff-display fs-700 align-center"
            style={{ "--gap": "0.5rem" }}
          >
            Avion <span className="ff-normal fw-700">Dashboard</span>
          </Link>
          <nav>
            <ul className="flex" style={{ "--gap": 2.75 + "rem" }}>
              <li>
