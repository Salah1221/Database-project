  ...
  return (
    <main>
      <section className="container">
        <h1 className="fs-900 fw-400 ff-display margin-bottom">All Users</h1>
        <div className="users grid">
          {users.length ? (
            users.map((user, i) => (
              <div className="grid bg-light-gray" key={i}>
                <div
                  className="username flex align-center"
                  style={{ "--gap": "0.5rem" }}
                >
                  <svg
                    width="24"
                  ...
                  <div className="fs-500 ff-display">
                    {user.first_name} {user.last_name}
                  </div>
                </div>
                <div className="grid bg-white border user-info">
                  <div className="fw-700">
                    Email: <span className="fw-400">{user.email}</span>
                  </div>
                  <div className="fw-700">
                    Password: <span className="fw-400">{user.password}</span>
                  </div>
                  <div className="fw-700">
                    Orders total sum:{" "}
                    <span className="fw-400">${user.total_purchased ?? 0}</span>
                  </div>
                </div>
              </div>
            ))
          ) : (
            <div className="text-align-center fs-900">No users found</div>
          )}
        </div>
      </section>
    </main>
